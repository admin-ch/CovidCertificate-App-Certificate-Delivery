...
public class DevEncryptionConfig {
    ...
    public class DevAppController extends AppController {
        ...
        private final String testHcert =
        ...
        private final String pathToTestPdf = "pdf/test_cert.pdf";
        ...
        private DbCovidCert mapAndEncrypt(DeliveryRegistration registration)
            ...
            dbCovidCert.setEncryptedHcert(encrypt(testHcert, publicKey, algorithm));
            dbCovidCert.setEncryptedPdf(
                    encrypt(encodeFileToBase64(pathToTestPdf), publicKey, algorithm));
            return dbCovidCert;
        }
        ...
        private String encodeFileToBase64(String path) throws IOException {
            return Base64.getEncoder()
                    .encodeToString(
                            Files.readAllBytes(
                                    new ClassPathResource(pathToTestPdf).getFile().toPath()));
        }
    }
}
